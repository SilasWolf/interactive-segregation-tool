...
ax_heatmap.set_xlabel('Volume fraction PS / %', fontsize=15, weight='bold')
ax_heatmap.set_ylabel('Size ratio / -', fontsize=15, weight='bold')
...
cbar.set_label('Surface enrichment / -', fontsize=15, weight='bold')
...
ax_plot_x.set_xlabel('Surface enrichment / -', fontsize=15, weight='bold')
...
ax_plot_y.set_ylabel('Surface enrichment / -', fontsize=15, weight='bold')
