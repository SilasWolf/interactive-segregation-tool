...
cbar.set_label('Surface enrichment / -', fontsize=10, weight='bold')
...
ax_plot_x.set_xlabel('Surface enrichment / -', fontsize=10, weight='bold')
...
ax_plot_y.set_ylabel('Surface enrichment / -', fontsize=10, weight='bold')
